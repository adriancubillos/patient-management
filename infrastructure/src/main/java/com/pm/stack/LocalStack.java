...
public class LocalStack extends Stack {
    ...
    private FargateService createFargateService(String id, String imageName, List<Integer> ports, DatabaseInstance db,
        ...
        if (db != null) {
            ...
            // In a real-world scenario, you would handle secrets more securely
            envVars.put("SPRING_DATASOURCE_PASSWORD", db.getSecret().secretValueFromJson("password").toString());
            //For learning purposes to get the data we have been using
            // Remove the next 2 entries for production use
